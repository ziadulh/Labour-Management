    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{((Route::currentRouteName()) == ('labour.create')) || ((Route::currentRouteName()) == ('labour.index'))  || ((Route::currentRouteName()) == ('labour.edit')) || ((Route::currentRouteName()) == ('labour.addAttendence')) || ((Route::currentRouteName()) == ('labour.show'))? 'menu-open' : ''}}">

              <a href="#" class="nav-link {{((Route::currentRouteName()) == ('labour.create')) || ((Route::currentRouteName()) == ('labour.index'))  || ((Route::currentRouteName()) == ('labour.edit')) || ((Route::currentRouteName()) == ('labour.addAttendence')) || ((Route::currentRouteName()) == ('labour.show')) ? 'active' : ''}}">
                <i class="nav-icon fa fa-circle"></i>
                <p>
                    Labour
                    <i class="right fa fa-angle-left"></i>
